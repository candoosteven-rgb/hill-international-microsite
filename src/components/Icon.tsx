const paths: Record<string, React.ReactNode> = {
  ...
  rocket: (
    <>
      <path d="M12 2c3 2 4.5 6 4.5 10.5 0 1.7-.3 3.3-.9 4.7L12 21l-3.6-3.8A13 13 0 0 1 7.5 12.5C7.5 8 9 4 12 2Z" />
      <circle cx="12" cy="10.5" r="1.8" />
      <path d="M8.3 15.5 5 17.5M15.7 15.5 19 17.5" />
      <path d="M10 19.5c.6 1 1.3 1.5 2 1.5s1.4-.5 2-1.5" />
    </>
  ),
  phone: (
  ...
  river: (
    <>
      <path d="M2 8c2.2-1.8 4.3-1.8 6.5 0s4.3 1.8 6.5 0 4.3-1.8 6.5 0" />
      <path d="M2 14c2.2-1.8 4.3-1.8 6.5 0s4.3 1.8 6.5 0 4.3-1.8 6.5 0" />
      <path d="M2 20c2.2-1.8 4.3-1.8 6.5 0s4.3 1.8 6.5 0 4.3-1.8 6.5 0" />
    </>
  ),
  terrace: (
    <>
